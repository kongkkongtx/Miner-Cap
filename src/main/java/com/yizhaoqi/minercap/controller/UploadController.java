...
import com.yizhaoqi.minercap.config.KafkaConfig;
import com.yizhaoqi.minercap.model.FileProcessingTask;
import com.yizhaoqi.minercap.model.FileUpload;
import com.yizhaoqi.minercap.repository.FileUploadRepository;
import com.yizhaoqi.minercap.service.FileTypeValidationService;
import com.yizhaoqi.minercap.service.UploadService;
...
public class UploadController {
    ...
    @Autowired
    private UploadService uploadService; //处理文件上传逻辑

    @Autowired
    private KafkaTemplate<String, Object> kafkaTemplate; //Kafka消息发送
    ...
    @Autowired
    private FileUploadRepository fileUploadRepository; //文件上传记录
