package com.yizhaoqi.minercap.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.yizhaoqi.minercap.exception.CustomException;
import com.yizhaoqi.minercap.model.OrganizationTag;
import com.yizhaoqi.minercap.model.User;
import com.yizhaoqi.minercap.repository.OrganizationTagRepository;
import com.yizhaoqi.minercap.repository.UserRepository;
import com.yizhaoqi.minercap.service.AdminService;
import com.yizhaoqi.minercap.service.UserService;
import com.yizhaoqi.minercap.utils.JwtUtils;
import com.yizhaoqi.minercap.utils.LogUtils;
...
@Tag(name="管理员接口", description="管理员控制器，提供管理知识库、查看系统状态和监控用户活动的接口")
public class AdminController {
    ...
    public ResponseEntity<?> getAllUsers(@RequestHeader("Authorization") String token) {
        ...
        if (users != null) {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(Map.of("code", 500, "message", "Failed to get users"));
        }
    }


    @PostMapping("/knowledge/add")
    @Operation(summary = "添加知识库文档", description = "管理员添加知识库文档")
    public ResponseEntity<?> addKnowledgeDocument(
        ...
        adminService.validateAdmin(adminUsername);
    ...
    @Operation(summary = "删除知识库文档", description = "管理员删除知识库文档")
    ...
    @Operation(summary = "获取系统状态", description = "管理员获取系统状态")
    ...
    @Operation(summary = "获取用户活动日志", description = "管理员获取用户活动日志")
    ...
    @Operation(summary = "创建管理员用户", description = "管理员创建管理员用户")
    ...
    @GetMapping("/org-tags")
    @Operation(summary = "获取所有组织标签", description = "管理员获取所有组织标签")
    ...
    @Operation(summary = "为用户分配组织标签", description = "管理员为用户分配组织标签")
    ...
    @Operation(summary = "获取组织标签树结构", description = "管理员获取组织标签树结构")
    ...
    @Operation(summary = "更新组织标签", description = "管理员更新组织标签")
    ...
    @Operation(summary = "删除组织标签", description = "管理员删除组织标签")
    ...
    @Operation(summary = "获取所有对话历史", description = "管理员获取所有对话历史")
    public ResponseEntity<?> getAllConversations(
        ...
        try {
            ...
            User admin = adminService.validateAdmin(adminUsername);
