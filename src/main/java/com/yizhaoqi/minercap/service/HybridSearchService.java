package com.yizhaoqi.minercap.service;

import co.elastic.clients.elasticsearch.ElasticsearchClient;
import co.elastic.clients.elasticsearch.core.SearchResponse;
import com.yizhaoqi.minercap.client.EmbeddingClient;
import com.yizhaoqi.minercap.entity.EsDocument;
import com.yizhaoqi.minercap.entity.SearchResult;
...
public class HybridSearchService {
    ...
    @Autowired
    private ElasticsearchClient esClient;//Elasticsearch客户端

    @Autowired
    private EmbeddingClient embeddingClient;//向量嵌入客户端
    ...
    @Autowired
    private OrgTagCacheService orgTagCacheService;//组织标签缓存服务
